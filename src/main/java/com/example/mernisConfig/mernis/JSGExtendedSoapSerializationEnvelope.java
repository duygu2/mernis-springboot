...
class JSGSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class JSGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JSGDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new JSGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JSGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JSGDateTimeConverter dateTimeConverter = new JSGStandardDateTimeConverter();

    public JSGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JSGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JSGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JSGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JSGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JSGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
