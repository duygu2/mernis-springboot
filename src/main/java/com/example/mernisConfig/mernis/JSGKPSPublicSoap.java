...
public class JSGKPSPublicSoap
{
    ...
    public JSGKPSPublicSoap(){}

    public JSGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JSGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JSGExtendedSoapSerializationEnvelope envelope= new JSGExtendedSoapSerializationEnvelope(JSGExtendedSoapSerializationEnvelope.VER11);
